...
const limiter = rateLimit({
 ...
 message:
    "System: Hệ thống đang nhận quá nhiều request từ phía IP bạn, bạn chờ 15 phút rồi trở lại.\nThere are too many connections from your IP, please try again after 15 mins!\nIPからの接続が多すぎます。15分後にもう一度やり直してください。"
});
//app.use(limiter);
...
//app.use('/_vhs', express.static('/media/kj/MyData/vhs_dc/parking/clip/_img_xera'), serveIndex('/media/kj/MyData/vhs_dc/parking/clip/_img_xera', {'icons': true}))
